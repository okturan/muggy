...
The headline SHALL be chosen from a fixed composition table keyed by load level (None, Easy, Noticeable, Real work, Hard, Dangerous) and texture band (dry, comfortable, humid, muggy, oppressive, miserable). The following rules SHALL apply:
...
- At Noticeable, Real work and Hard, load leads and texture appears only as a qualifier.
...
- **WHEN** the shade and sun levels are both Real work
...
- **WHEN** texture is humid, the shade level is Noticeable and the sun level is Real work
...
- Breaks and water require Real work or above.
...
- **WHEN** the shade level is Real work and the sun level is Hard
